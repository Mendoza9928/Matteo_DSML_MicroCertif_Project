...
# Boxplot avec les catégories M, L, H et légende améliorée
...
plt.xlabel('Échec de la Machine (Target)')
...
dashboard = pn.Column(
    ...
    pn.Row(boxplot_torque_target_panel, scatterplot_tempdiff_toolwear_panel)
)
